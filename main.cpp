...
int main() {
    sf::ContextSettings contextSettings(24, 8, 0, 4, 5,
                                        sf::ContextSettings::Attribute::Core);
    sf::Window window(sf::VideoMode(1980, 1000), "Triangle", sf::Style::Default,
                      contextSettings);
    ...
    LoadedModel *nanosuit = new LoadedModel(
            static_cast<GLchar *>("nanosuit/nanosuit.obj"));
    engine.Assign(
            new Object(nanosuit, glm::vec3(0.0f, 0.0f, 0.0f),
                       glm::vec3(0.f, 180.f, 0.f),
                       glm::vec3(0.3f, 0.3f, 0.3f)));
    LoadedModel *cyborg = new LoadedModel(
            static_cast<GLchar *>("cyborg/cyborg.obj"));
    engine.Assign(
            new Object(cyborg, glm::vec3(2.0f, 0.0f, 0.0f),
                       glm::vec3(0.f, 180.f, 0.f),
    ...
    for (int i = -10; i <= 10; ++i) {
        engine.Assign(
                new Object(new Line(vertices_x, 0, -std::sqrt(3.f) / 2, i),
                           glm::vec3(0.0f, 0.0f, 0.0f),
                           glm::vec3(0.f, 0.f, 0.f), glm::vec3(1.f, 1.f, 1.f)));
        engine.Assign(
                new Object(new Line(vertices_z, i, -std::sqrt(3.f) / 2, 0),
                           glm::vec3(0.0f, 0.0f, 0.0f),
                           glm::vec3(0.f, 0.f, 0.f), glm::vec3(1.f, 1.f, 1.f)));
    }
...
//                         glm::vec3(0.5f, 0.5f, 0.5f)));
    ...
    for (int i = 0; i < pointLightPositions.size() - 2; ++i) {
        engine.AddPointLight(
                new PointLight(pointLightPositions[i], 1.0, 0.09, 0.032,
    ...
    engine.AddPointLight(
            new PointLight(pointLightPositions[2], 1.0, 0.09, 0.032,
                           glm::vec3(0.f, 0.2f, 0.f),
                           glm::vec3(0.f, 0.8f, 0.f),
                           glm::vec3(0.0f, 1.0f, 0.0f), engine.white_shader));

    engine.AddPointLight(
            new PointLight(pointLightPositions[3], 1.0, 0.09, 0.032,
                           glm::vec3(0.2f, 0.f, 0.f),
                           glm::vec3(0.8f, 0.f, 0.f),
                           glm::vec3(1.0f, 0.0f, 0.0f), engine.white_shader));
