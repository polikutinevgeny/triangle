...
int main() {
    ...
    sf::Window window(
            sf::VideoMode(640, 480), "SFML window with OpenGL",
    ...
    while (window.isOpen()) {
        ...
        GLfloat greenValue = (sinf(timeValue) / 2) + 0.5f;
        GLint vertexColorLocation = glGetUniformLocation(shaderProgram, "ourColor");
        glUniform4f(vertexColorLocation, (1.f - greenValue), greenValue, 0.0f, 1.0f);
        GLint vertexPositionShiftLocation = glGetUniformLocation(shaderProgram, "positionShift");
        glUniform3f(vertexPositionShiftLocation, 0.0f, greenValue * 0.5f, 0.0f);
        glBindVertexArray(VAO);
